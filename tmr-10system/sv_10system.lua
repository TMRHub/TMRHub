local QBCore = exports['qb-core']:GetCoreObject()
 ...
 AddEventHandler("10system:add", function()
     ...
     TriggerClientEvent("qb-10system:client:update", -1, data)
 end)
...
AddEventHandler("TokoVoip:talkingstatus", function(sid, status)
    ...
    TriggerClientEvent("qb-voice:setTalkingOnRadio", xPlayer.PlayerData.source, xPlayer.PlayerData.source, status)
